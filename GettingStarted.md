...
- Colab has limited computing resources, but that should **not** be an issue for our class labs and projects.
  ...
  ### I have uploaded Lab 1 to collab for you, so all you need to do is go to the following link, and make a copy for yourself (in your google drive): (Collab)[https://colab.research.google.com/drive/1pcs7VSt_2RsNQgB_L9SgHCSLKjpJSaft?usp=sharing
